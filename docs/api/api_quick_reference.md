...
| GET | `/qa/questions/list/` | 获取问题列表 | 登录用户 | ✅ |
| GET | `/qa/questions/{id}/` | 获取问题详情 | 登录用户 | ✅ |
...
### 获取问题列表 ✅
```bash
curl -X GET "http://localhost:8000/api/v1/qa/questions/list/?page=1&page_size=10&subject=Python" \
  -H "Authorization: Bearer <student_token>"
```
